...
impl Default for BuyHeuristic {
    fn default() -> Self {
        BuyHeuristic {
            ...
            crypto_max_mvrv: 0.0,          // (#45) off by default. ci-settings ships 2.0 — the SAME point `nupl_euphoria: 0.5` already calls greed (NUPL 0.5 <=> MVRV 2.0), so the damp and the ceiling share one definition of "expensive"; see the knob doc
