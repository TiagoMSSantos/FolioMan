...
pub struct BuyHeuristic {
    ...
    pub growth_maxdd_cap: f64,       // (#26) hard gate: reject equities whose worst-ever drawdown MAGNITUDE exceeds this % (e.g. 83 rejects a name that ever fell >83% peak-to-trough). 0 = off (default). Crypto exempt (BTC itself is -83%)
