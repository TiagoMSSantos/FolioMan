...
impl Default for Sizing {
    fn default() -> Self {
        Self {
            ...
            max_sector_pct: 25.0,
            spill_names: 3,
            spill_per_tier: false, // (#288) OFF = the (#261) walk-down, i.e. today's three all-world trackers. Non-negotiable #1.
        }
    }
}
